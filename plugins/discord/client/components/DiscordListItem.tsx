...
function DiscordListItem({ integration, collection }: Props) {
  ...
  return (
    <ListItem
      ...
      subtitle={
        <>
          <Trans defaults="Posting to Discord on" />{" "}
          <Popover>
            <PopoverTrigger>
              <ButtonLink>
            ...
            <PopoverContent side="bottom" align="start">
              <Events>
                ...
                <Text as="p" type="secondary">
                  {t("These events should be posted to Discord")}
                </Text>
                <Switch
      ...
      actions={
        <ConnectedButton
          ...
          confirmationMessage={t(
            "This will prevent any future updates from being posted to this Discord channel. Are you sure?"
          )}
        />
      }
    />
...
export default observer(DiscordListItem);
